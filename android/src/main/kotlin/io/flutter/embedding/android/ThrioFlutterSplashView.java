...
/**
 * {@code View} that displays a {@link SplashScreen} until a given {@link ThrioFlutterView} renders its
 * first frame.
 */
/* package */ final class ThrioFlutterSplashView extends FrameLayout {
    private static String TAG = "ThrioFlutterSplashView";
    ...
    @NonNull
    private final ThrioFlutterView.FlutterEngineAttachmentListener flutterEngineAttachmentListener =
            new ThrioFlutterView.FlutterEngineAttachmentListener() {
                @Override
    ...
    public ThrioFlutterSplashView(@NonNull Context context) {
        this(context, null, 0);
    }

    public ThrioFlutterSplashView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ThrioFlutterSplashView(
     ...
     *
     * <p>If no {@code splashScreen} is provided, this {@code ThrioFlutterSplashView} displays the given
     * {@code flutterView} on its own.
     */
    public void displayFlutterViewWithSplash(
            @NonNull ThrioFlutterView flutterView, @Nullable SplashScreen splashScreen) {
     ...
     *
     * <p>This method requires that our ThrioFlutterView be attached to an engine, and that engine have a
