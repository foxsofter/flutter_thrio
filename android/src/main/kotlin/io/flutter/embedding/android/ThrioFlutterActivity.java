 ...
 *
 * <p>{@code ThrioFlutterActivity} is the simplest and most direct way to integrate Flutter within an
 * Android app.
 *
 * <p><strong>ThrioFlutterActivity responsibilities</strong>
 *
 * <p>{@code ThrioFlutterActivity} maintains the following responsibilities:
 *
 * <ul>
 ...
 * the entrypoint that a {@code ThrioFlutterActivity} executes, subclass {@code ThrioFlutterActivity} and
 ...
 * of {@code ThrioFlutterActivity} by overriding their respective methods:
 *
 * <ul>
 ...
 *
 * <p>{@code ThrioFlutterActivity} can be used with a cached {@link FlutterEngine} instead of creating a
 * new one. Use {@link #withCachedEngine(String)} to build a {@code ThrioFlutterActivity} {@code Intent}
 ...
 *
 * <ul>
 *   <li>When {@code ThrioFlutterActivity} is the first {@code Activity} displayed by the app, because
 ...
 * }</pre>
 *
 * <p><strong>Alternatives to ThrioFlutterActivity</strong>
 *
 ...
 * ThrioFlutterView}. Using a {@link ThrioFlutterView} requires forwarding some calls from an {@code
 ...
 *
 * <p>{@code ThrioFlutterActivity} supports the display of an Android "launch screen" as well as a
 * Flutter-specific "splash screen". The launch screen is displayed while the Android application
 * loads. It is only applicable if {@code ThrioFlutterActivity} is the first {@code Activity} displayed
 ...
 *
 * <p>In the AndroidManifest.xml, set the theme of {@code ThrioFlutterActivity} to the defined launch
 * theme. In the metadata section for {@code ThrioFlutterActivity}, defined the following reference to
 * your normal theme:
 *
 ...
 * initialization, subclass {@code ThrioFlutterActivity} and override {@link #provideSplashScreen()}. See
 ...
 * the following metadata in AndroidManifest.xml for this {@code ThrioFlutterActivity}:
 *
 ...
 * is similar to {@code ThrioFlutterActivity} but it extends {@code FragmentActivity}. You should use
 * {@code ThrioFlutterActivity}, if possible, but if you need a {@code FragmentActivity} then you should
...
public class ThrioFlutterActivity extends Activity
     ...
     * launch a {@code ThrioFlutterActivity} that internally creates a new {@link FlutterEngine} using the
     * desired Dart entrypoint, initial route, etc.
     */
    @NonNull
    public static NewEngineIntentBuilder withNewEngine() {
        return new NewEngineIntentBuilder(ThrioFlutterActivity.class);
    }

    /**
     * Builder to create an {@code Intent} that launches a {@code ThrioFlutterActivity} with a new {@link
     * FlutterEngine} and the desired configuration.
     */
    public static class NewEngineIntentBuilder {
        private final Class<? extends ThrioFlutterActivity> activityClass;
        private String initialRoute = DEFAULT_INITIAL_ROUTE;
        private String backgroundMode = DEFAULT_BACKGROUND_MODE;

        /**
         * Constructor that allows this {@code NewEngineIntentBuilder} to be used by subclasses of
         * {@code ThrioFlutterActivity}.
         *
         * <p>Subclasses of {@code ThrioFlutterActivity} should provide their own static version of {@link
         * #withNewEngine()}, which returns an instance of {@code NewEngineIntentBuilder} constructed
         * with a {@code Class} reference to the {@code ThrioFlutterActivity} subclass, e.g.:
         *
         * <p>{@code return new NewEngineIntentBuilder(MyFlutterActivity.class); }
         */
        public NewEngineIntentBuilder(@NonNull Class<? extends ThrioFlutterActivity> activityClass) {
        ...
        /**
         * The mode of {@code ThrioFlutterActivity}'s background, either {@link BackgroundMode#opaque} or
         ...
         * {@link ThrioFlutterView} of this {@code ThrioFlutterActivity} to be configured with a {@link
         ...
         * being implemented.
         *
         * <p>A {@code ThrioFlutterActivity} that is configured with a background mode of {@link
        ...
        /**
         * Creates and returns an {@link Intent} that will launch a {@code ThrioFlutterActivity} with the
     ...
     * to launch a {@code ThrioFlutterActivity} that internally uses an existing {@link FlutterEngine} that
     * is cached in {@link io.flutter.embedding.engine.FlutterEngineCache}.
     */
    public static CachedEngineIntentBuilder withCachedEngine(@NonNull String cachedEngineId) {
        return new CachedEngineIntentBuilder(ThrioFlutterActivity.class, cachedEngineId);
    }

    /**
     * Builder to create an {@code Intent} that launches a {@code ThrioFlutterActivity} with an existing
    ...
    public static class CachedEngineIntentBuilder {
         ...
         * constructed with a {@code Class} reference to the {@code ThrioFlutterActivity} subclass, e.g.:
         *
         * <p>{@code return new CachedEngineIntentBuilder(MyFlutterActivity.class, engineId); }
         */
        public CachedEngineIntentBuilder(
                @NonNull Class<? extends ThrioFlutterActivity> activityClass, @NonNull String engineId) {
            this.activityClass = activityClass;
         ...
         * cache when this {@code ThrioFlutterActivity} is destroyed.
         *
     ...
     *
     * <p>The testing infrastructure should be upgraded to make ThrioFlutterActivity tests easy to write
    ...
    @VisibleForTesting
    /* package */ void setDelegate(@NonNull ThrioFlutterPageDelegate delegate) {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        delegate = new ThrioFlutterPageDelegate(this);
     ...
     *   <li>In the AndroidManifest.xml, set the theme of your {@code ThrioFlutterActivity} to your launch
     *       theme.
     *   <li>Add a {@code <meta-data>} property to your {@code ThrioFlutterActivity} with a name of
    ...
    private void switchLaunchThemeForNormalTheme() {
        try {
            ...
            Log.e(
                    TAG,
                    "Could not read meta-data for ThrioFlutterActivity. Using the launch theme as normal theme.");
        }
    }
    ...
    /**
     * {@link ThrioFlutterPageDelegate.Host} method that is used by {@link
     * ThrioFlutterPageDelegate} to obtain a {@code Context} reference as needed.
     */
    @Override
    @NonNull
    ...
    /**
     * {@link ThrioFlutterPageDelegate.Host} method that is used by {@link
     * ThrioFlutterPageDelegate} to obtain an {@code Activity} reference as needed. This
     * reference is used by the delegate to instantiate a {@link ThrioFlutterView}, a {@link
    ...
    /**
     * {@link ThrioFlutterPageDelegate.Host} method that is used by {@link
     * ThrioFlutterPageDelegate} to obtain a {@code Lifecycle} reference as needed. This
    ...
    /**
     * {@link ThrioFlutterPageDelegate.Host} method that is used by {@link
     * ThrioFlutterPageDelegate} to obtain Flutter shell arguments when initializing
     * Flutter.
     */
    @NonNull
    @Override
     ...
     * ThrioFlutterActivity}, or {@code null} if this {@code ThrioFlutterActivity} does not want to use a cached
     * {@link FlutterEngine}.
     */
    @Override
    @Nullable
    ...
    /**
     * Returns false if the {@link FlutterEngine} backing this {@code ThrioFlutterActivity} should outlive
     * this {@code ThrioFlutterActivity}, or true to be destroyed when the {@code ThrioFlutterActivity} is
     * destroyed.
     *
     * <p>The default value is {@code true} in cases where {@code ThrioFlutterActivity} created its own
     ...
     * definition for this {@code ThrioFlutterActivity}.
     *
     ...
     *
     * <p>When this {@code ThrioFlutterActivity} is run by Flutter tooling and a data String is included in
    ...
    /**
     * {@link ThrioFlutterPageDelegate.Host} method that is used by {@link
     * ThrioFlutterPageDelegate} to obtain the desired {@link RenderMode} that should be
     * used when instantiating a {@link ThrioFlutterView}.
     */
    @NonNull
    @Override
    ...
    /**
     * {@link ThrioFlutterPageDelegate.Host} method that is used by {@link
     * ThrioFlutterPageDelegate} to obtain the desired {@link TransparencyMode} that should
     * be used when instantiating a {@link ThrioFlutterView}.
     */
    @NonNull
    @Override
     ...
     * ThrioFlutterActivity} is being subclassed to utilize a custom and/or cached {@link FlutterEngine}.
     *
     ...
     * this {@code ThrioFlutterActivity} will connect its {@link FlutterEngine} to itself, along with any
     ...
     * {@code ThrioFlutterActivity} will not automatically manage the connection between its {@link
     ...
     * attaching to a {@code ThrioFlutterActivity} - it just prevents the attachment from happening
     * automatically. A developer can choose to subclass {@code ThrioFlutterActivity} and then invoke
     ...
     * outlive this {@code ThrioFlutterActivity} so that it can be used later in a different {@code
     * Activity}. To accomplish this, the {@link FlutterEngine} may need to be disconnected from this
     * {@code FluttterActivity} at an unusual time, preventing this {@code ThrioFlutterActivity} from
