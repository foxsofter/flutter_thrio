...
A flutter plugin which enables hybrid integration of flutter for existing ios or android apps.
  ...
  s.public_header_files = ["Classes/*.h",
                           "Classes/Category/*.h",
                           "Classes/Channel/*.h",
                           "Classes/Flutter/ThrioFlutterEngine.h",
                           "Classes/Logger/*.h",
                           ...
                           "Classes/Navigator/NavigatorFlutterEngine.h",
                           "Classes/Navigator/NavigatorFlutterEngineGroup.h",
                           "Classes/Navigator/NavigatorFlutterEngineIdentifier.h",
                           ...
                           "Classes/Navigator/NavigatorPageObserverChannel.h",
                           "Classes/Navigator/NavigatorPageObserverProtocol.h",
                           "Classes/Navigator/NavigatorPageRoute.h",
                           "Classes/Navigator/NavigatorRouteObserverChannel.h",
                           "Classes/Navigator/NavigatorRouteObserverProtocol.h",
                           "Classes/Navigator/NavigatorRouteReceiveChannel.h",
